    ...
    <main className="min-h-screen p-4 sm:p-6 lg:p-8">
      <div className="page-shell">
          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div>
              ...
              <p className="mt-4 max-w-2xl text-base sm:text-lg text-slate-600">
                View production lines grouped by status. Use filters to narrow
                down by order status, priority, overdue lines, or completed
                production stages.
              </p>
            </div>
        ...
        <section className="mt-8 section-card-strong">
          <form
            method="GET"
            className="grid gap-4 lg:grid-cols-[1.4fr_repeat(3,0.7fr)_auto]"
          >
            <div>
        ...
        <section className="mt-8 section-card-strong">
          <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <h2 className="mt-2 text-3xl font-bold">Kanban View</h2>
            </div>

            <span className="status-pill">
              Showing {typedLines.length} line
              {typedLines.length === 1 ? "" : "s"}
            </span>
          </div>
