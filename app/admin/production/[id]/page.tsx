...
import EditOrderForm from "../../orders/[id]/edit-order-form";
import FactoryActions from "../../orders/[id]/factory-actions";
import ProductionLineEditor from "../../orders/[id]/production-line-editor";
    ...
    <main className="min-h-screen bg-slate-50 p-8 text-slate-900">
      <div className="mx-auto max-w-7xl space-y-8">
        ...
        <div className="rounded-2xl border bg-white p-6 shadow-sm">
          <p className="text-sm text-slate-500">Production Order</p>
          ...
          <div className="mt-4 grid gap-4 text-sm text-slate-500 sm:grid-cols-2 lg:grid-cols-6">
            <div>
          ...
          <div className="space-y-8">
            <div className="rounded-2xl border bg-white p-6 shadow-sm">
              ...
              <p className="mt-2 text-sm text-slate-500">
                Update status, notes, and basic admin details.
              </p>
            ...
            <div className="rounded-2xl border bg-white p-6 shadow-sm">
              ...
              {typedProductionLines.length === 0 ? (
                <div className="mt-6 rounded-xl border border-dashed bg-slate-50 p-6 text-sm text-slate-500">
                  No production lines yet. They will appear once the order is
                  sent to factory and includes valid Part # / Frame Needed
                  combinations.
                </div>
              ) : (
